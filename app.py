...
def main():
    ...
    if withdrawal_method == "Fixed % of prior-year end balance":
        ...
        withdrawal_frequency = st.sidebar.radio(
            ...
            key="withdrawal_frequency_radio",
